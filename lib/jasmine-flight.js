...
(function (root) {
  ...
  root.describeComponent = function (componentName, componentInstance, specDefinitions) {
    jasmine.getEnv().describeComponent(componentName, componentInstance, specDefinitions);
  };

  root.ddescribeComponent = function (componentName, componentInstance, specDefinitions) {
    jasmine.getEnv().ddescribeComponent(componentName, componentInstance, specDefinitions);
  };

  var describeComponentFactory = function (componentName, componentInstance, specDefinitions) {
    return function () {
      beforeEach(function () {
  ...
  jasmine.Env.prototype.describeComponent = function (componentName, componentInstance, specDefinitions) {
    describe(componentName, describeComponentFactory(componentName, componentInstance, specDefinitions));
  };

  jasmine.Env.prototype.ddescribeComponent = function (componentName, componentInstance, specDefinitions) {
    ddescribe(componentName, describeComponentFactory(componentName, componentInstance, specDefinitions));
  };
  ...
  root.describeMixin = function (mixinName, mixinInstance, specDefinitions) {
    jasmine.getEnv().describeMixin(mixinName, mixinInstance, specDefinitions);
  };

  root.ddescribeMixin = function (mixinName, mixinInstance, specDefinitions) {
    jasmine.getEnv().ddescribeMixin(mixinName, mixinInstance, specDefinitions);
  };

  var describeMixinFactory = function (mixinName, mixinInstance, specDefinitions) {
    return function () {
      beforeEach(function () {
        this.Component = this.component = this.$node = null;

        flight.registry.reset();
        this.Component = flight.component(function () {}, new mixinInstance());
  ...
  jasmine.Env.prototype.describeMixin = function (mixinName, mixinInstance, specDefinitions) {
    describe(mixinName, describeMixinFactory(mixinName, mixinInstance, specDefinitions));
  };

  jasmine.Env.prototype.ddescribeMixin = function (mixinName, mixinInstance, specDefinitions) {
    ddescribe(mixinName, describeMixinFactory(mixinName, mixinInstance, specDefinitions));
  };
  ...
  root.describeModule = function (moduleName, moduleInstance, specDefinitions) {
    return jasmine.getEnv().describeModule(moduleName, moduleInstance, pecDefinitions);
  };

  jasmine.Env.prototype.describeModule = function (moduleName, moduleInstance, specDefinitions) {
